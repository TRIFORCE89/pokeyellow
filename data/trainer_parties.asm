...
;JessieJamesData:
	db 16,EKANS,MEOWTH,KOFFING,0 ; Mt. Moon B2F
	db 27,KOFFING,MEOWTH,EKANS,0 ; Rocket Hideout B4F
	db 29,MEOWTH,ARBOK,WEEZING,WEEPINBELL,0 ; Pokémon Tower 7F
	db 33,WEEZING,ARBOK,VICTREEBEL,LICKITUNG,MEOWTH,0 ; Silph Co. 11F
...
; Victory Road 3F
	db 43,EXEGGUTOR,SANDSLASH,CLOYSTER,ELECTRODE,ARCANINE,0
	db 43,KINGLER,TENTACRUEL,BLASTOISE,0
; Unused
	db 45,KINGLER,STARMIE,0
; Victory Road 1F
	db 42,RATICATE,IVYSAUR,WARTORTLE,CHARMELEON,CHARIZARD,0
; Unused
	db 44,IVYSAUR,WARTORTLE,CHARMELEON,0
	db 49,NIDOKING,0
	db 44,KINGLER,CLOYSTER,0
; Viridian Gym
	db 39,SANDSLASH,GRAVELER,ONIX,DUGTRIO,MAROWAK,0
	db 43,RHYHORN,0
CooltrainerFData:
; Celadon Gym
	db 24,BELLSPROUT,ODDISH,WEEPINBELL,GLOOM,IVYSAUR,0
; Victory Road 3F
	db 43,BELLSPROUT,WEEPINBELL,VICTREEBEL,PARAS,PARASECT,0
	db 43,CLEFAIRY,JIGGLYPUFF,PARASECT,DEWGONG,CHANSEY,0
; Unused
	db 46,VILEPLUME,BUTTERFREE,0
; Victory Road 1F
	db 44,PERSIAN,PONYTA,RAPIDASH,VULPIX,NINETALES,0
; Unused
...
BrockData:
	db $FF,5,ZUBAT,10,VULPIX,12,GEODUDE,14,ONIX,0
MistyData:
	db $FF,8,GOLDEEN,10,HORSEA,15,PSYDUCK,18,STARYU,21,STARMIE,0
LtSurgeData:
	db $FF,21,VOLTORB,24,MAGNEMITE,28,RAICHU,0
ErikaData:
	db $FF,29,GLOOM,29,WEEPINBELL,30,TANGELA,32,VICTREEBEL,32,VILEPLUME,0
KogaData:
	db $FF,43,VENONAT,44,SCYTHER,46,GOLBAT,48,MUK,50,VENOMOTH,0
BlaineData:
	db $FF,42,NINETALES,47,RHYDON,48,MAGMAR,50,RAPIDASH,54,ARCANINE,0
SabrinaData:
	db $FF,37,ABRA,38,HAUNTER,41,KADABRA,43,HYPNO,44,MR_MIME,50,ALAKAZAM,0
GentlemanData:
; SS Anne 1F Rooms
